...
// @ts-ignore
import autoScroll from '@christophhu/dom-autoscroller';

// @ts-ignore
// const autoScroll = require('@mattlewis92/dom-autoscroller');
...
export class DragDirective {
  ...
  */
  ...
  constructor(
    ...
    private draggableHelper: DragHelper,
    private zone: NgZone,
    private vcr: ViewContainerRef,
    @Optional() private scrollContainer: DragScrollContainerDirective,
    ...
    const pointerDragged$: Observable<any> = this.pointerDown$.pipe(
      ...
      mergeMap((pointerDownEvent: PointerEvent) => {
        ...
        dragStarted$.subscribe(({ clientX, clientY, x, y }) => {
          ...
          this.scroller = autoScroll([this.scrollContainer ? this.scrollContainer.elementRef.nativeElement : this.document.defaultView], { ...this.autoScroll, autoScroll() {
              return true
            }
          })
