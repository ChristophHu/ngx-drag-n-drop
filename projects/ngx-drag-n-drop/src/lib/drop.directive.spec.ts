...
import { DraggableScrollContainerDirective, DragAndDropModule } from 'angular-draggable-droppable';
import { triggerDomEvent } from '../../../ngx-draggable-droppable/src/test-utils';
import { DropDirective, ValidateDrop } from './drop.directive';
...
describe('droppable directive', () => {
  ...
  class TestComponent {
    @ViewChild(DragDirective) draggable: DragDirective;
    @ViewChild(DropDirective) droppable: DropDirective;
